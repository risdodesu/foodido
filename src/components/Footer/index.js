        ...
        <div className='footer container-fluid'>
            <div className='row'>
                <div className='col-12 col-md-6 col-lg-6'>
                    <h3 className='mb-3 d-flex align-item-center justify-content-center'>Follow Us</h3>
                ...
                <div className='col-12 col-md-6 col-lg-6'>
                    <h3 className='mb-3 d-flex align-item-center justify-content-center'>Contact Us</h3>
